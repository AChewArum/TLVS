...
namespace TL_Physics
{
	...
	/// </summary>
	class PHYSICS_DLL_DECLSPEC PhysicsObject// : public IPhysicsObject
	{
	public:
		...
		bool CreateShape(ColliderInfo& colliderInfo, TransformInfo& transformInfo, PhysicsMaterial* material = nullptr);
		...
		/// <returns>success</returns>
		bool AddForce(TL_Math::Vector3 vector, int forceMode);
		...
		/// <returns>success</returns>
		bool AddTorque(TL_Math::Vector3 torque, int forceMode);
		...
		/// <summary>
		/// Apply a physics material to shape
		/// </summary>
		/// <param name="physicsMaterial">physics materiall</param>
		/// <returns>success</returns>
		bool SetPhysicsMaterial(TL_Physics::PhysicsMaterial* physicsMaterial);

...
namespace TL_Physics
{
	...
	public:
		...
		virtual void SetCenter(TL_Math::Vector3 center) abstract;

		/// <summary>
		/// Set box half-size
		/// </summary>
		/// <param name="size">half-size</param>
		virtual void SetSize(TL_Math::Vector3 size) abstract;
		...
		virtual bool SetLinearVelocity(TL_Math::Vector3 velocity) abstract;
		virtual bool SetAngularVelocity(TL_Math::Vector3 velocity) abstract;
		...
		/// <returns>success</returns>
		virtual bool AddForce(TL_Math::Vector3 vector, int forceMode) abstract;
		...
		/// <returns>success</returns>
		virtual bool AddTorque(TL_Math::Vector3 torque, int forceMode) abstract;

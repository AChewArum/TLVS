...
namespace TL_Physics
{
	...
	public:
		...
		virtual bool Raycast(TL_Math::Vector3 origin, TL_Math::Vector3 unitDir, RaycastHitInfo& reycastHitInfo, float maxDistance, uint32 layerMask) abstract;
		...
		/// @param maxDistance Length of the ray, Has to be in the [0, inf] range
		/// @return If ray hit object in the scene, return object information
		virtual bool Raycast(TL_Math::Vector3 origin, TL_Math::Vector3 unitDir, float maxDistance, uint32 layerMask) abstract;
		...
		/// @return Success
		virtual bool DeletePhysicsObject(TL_Physics::PhysicsObject* physicsObject) abstract;
		...
		virtual bool SetErrorCallback(TL_Common::ErrorCallback* errorCallback) abstract;
	};

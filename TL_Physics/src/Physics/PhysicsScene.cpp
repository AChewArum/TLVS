...
TL_Physics::PhysicsScene::PhysicsScene(physx::PxPhysics* physics, physx::PxCpuDispatcher* dispatcher)
:	m_pPhysics(physics)
...
TL_Physics::PhysicsScene::~PhysicsScene()
{
	m_pScene->release();
...
void TL_Physics::PhysicsScene::InitScene(PhysicsInfo& sceneInfo)
{
...
UID TL_Physics::PhysicsScene::CreatePhysicObject()
{
	UID uid = 0;
...
bool TL_Physics::PhysicsScene::DeletePhysicsObject(UID id)
{
...
void TL_Physics::PhysicsScene::AddActors(PxActor* const* actors, PxU32 nbActors)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
void TL_Physics::PhysicsScene::AddActors(const PxPruningStructure& pruningStructure)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
void TL_Physics::PhysicsScene::RemoveActor(PxActor& actor, bool wakeOnLostTouch /*= true*/)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
void TL_Physics::PhysicsScene::RemoveActors(PxActor* const* actors, PxU32 nbActors, bool wakeOnLostTouch /*= true*/)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
void TL_Physics::PhysicsScene::AddAggregate(PxAggregate& aggregate)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
void TL_Physics::PhysicsScene::RemoveAggregate(PxAggregate& aggregate, bool wakeOnLostTouch /*= true*/)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
void TL_Physics::PhysicsScene::AddCollection(const PxCollection& collection)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
void TL_Physics::PhysicsScene::ShiftOrigin(const PxVec3& shift)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
physx::PxPvdSceneClient* TL_Physics::PhysicsScene::GetScenePvdClient()
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
bool TL_Physics::PhysicsScene::Raycast(PxVec3 origin, PxVec3 unitDir, PxReal maxDistance, PxRaycastBuffer& buffer, uint32 layerMask)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
void TL_Physics::PhysicsScene::Simulate(float elapseTime)
{
#ifdef _DEBUG
	NullCheckScene;
#endif // _DEBUG
...
std::vector<TL_Physics::CollisionEvent>& TL_Physics::PhysicsScene::GetCollisionEvents()
{
	return m_EventCallBack->GetCollisionEvents();
}

std::vector<TL_Physics::TriggerEvent>& TL_Physics::PhysicsScene::GetTriggerEvents()
{
	return m_EventCallBack->GetTriggerEvents();
}

bool TL_Physics::PhysicsScene::SetEventCallback(PxSimulationEventCallback* eventCallback)
{
#ifdef _DEBUG
	NullCheckScene;
#endif

...
TL_Physics::BaseEventCallBack::~BaseEventCallBack()
{

}

void TL_Physics::BaseEventCallBack::onConstraintBreak(PxConstraintInfo* constraints, PxU32 count)
{

}

void TL_Physics::BaseEventCallBack::onWake(PxActor** actors, PxU32 count)
{

}

void TL_Physics::BaseEventCallBack::onSleep(PxActor** actors, PxU32 count)
{

}

void TL_Physics::BaseEventCallBack::onContact(const PxContactPairHeader& pairHeader, const PxContactPair* pairs, PxU32 nbPairs)
{
	...
	for (size_t i = 0; i < nbPairs; i++)
	{
		...
		PxContactPairPoint _points[100];
...
void TL_Physics::BaseEventCallBack::onTrigger(PxTriggerPair* pairs, PxU32 count)
{
...
void TL_Physics::BaseEventCallBack::onAdvance(const PxRigidBody* const* bodyBuffer, const PxTransform* poseBuffer, const PxU32 count)
{

}

void TL_Physics::BaseEventCallBack::Tick()
{

...
#include "Physics\Metal\BaseErrorCallback.h"
...
namespace TL_Physics
{
	...
	BaseErrorCallback::BaseErrorCallback(TL_Common::ErrorCallback* callBack)
		: m_pErrorCallback(callBack)
	{
		m_pErrorCallback->Log("Physics Error Callback Init success");
	}

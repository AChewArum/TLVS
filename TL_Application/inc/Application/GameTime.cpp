...
namespace TL_Application
{
	...
	void GameTime::PreTick()
	{
		...
		constexpr long long CLAMP_MAX_DELTA_TIME_NANOS = (double)((double)1 / (double)50) * SECOND_TO_NANOS;
		...
		{
			m_DeltaTimeNanos = CLAMP_MAX_DELTA_TIME_NANOS;
